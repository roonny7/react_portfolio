    ...
    <>
        ...
        <div className="row">
            ...
            <ul className="list-unstyled">
                <li><Link to="/" >Follow on Twitter</Link></li>
                <li><Link to="/react">Like on Facebook</Link></li>
                <li><Link to="/react">Email me</Link></li>
            </ul>
            </div>
        </div>
        </div>
        ...
        <div className="col-lg-6 col-md-8 mx-auto">
            <h1 className="fw-light">Módulos</h1>
            <p className="lead text-body-secondary">Portfolio React - Node</p>
            <p>
            <a href="/" className="btn btn-primary my-2">Sobre mi</a>&nbsp;
            <a href="/" className="btn btn-secondary my-2">Github</a>
            </p>
        </div>
        </div>
        </section>
        ...
        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            ...
            <img src="imagenes/correspondencia.jpg" title="Correspondencia" alt="Correspondencia"></img>
                
                <div className="card-body">
                <p className="card-text">Buscar por correspondencia</p>
                <div className="d-flex justify-content-between align-items-center">
                    <div className="btn-group">
                    <Link to="/correspondencia" type="button" className="btn btn-sm btn-outline-secondary">Por ID</Link>
                    <Link to="/correspondencia" type="button" className="btn btn-sm btn-outline-secondary">Por folio</Link>
                    </div>
                    <small className="text-body-secondary">React-Node</small>
                </div>
                </div>
            </div>
            </div>
            ...
            <div className="card shadow-sm">
                ...
                <div className="d-flex justify-content-between align-items-center">
                    <div className="btn-group">
                    <Link to="/" className="btn btn-sm btn-outline-secondary">ptmmmmmmmmmmmmmmmmmmm</Link>
